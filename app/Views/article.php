        ...
        <div class="uk-margin-top uk-margin-bottom" uk-grid>
            <div class="uk-width-expand">
                <ul class="uk-breadcrumb uk-margin-remove">
                    ...
                    <li><a href="<?= site_url('General.news') ?>"><?= lang('General.news') ?></a></li>
                </ul>
                <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= esc($article->title) ?></h1>
                <p class="uk-text-meta uk-margin-remove"><i class="fa-solid fa-calendar-day"></i> <time datetime="<?= $article->createdAt ?>"><?= localeDate($article->createdAt) ?></time></p>
            </div>
            <div class="uk-width-auto"></div>
        </div>
        <div class="uk-margin" uk-grid>
            <div class="uk-width-2-3@s uk-width-3-4@m">
                <?php /*<?= $template['partials']['alerts'] ?> */ ?>
                ...
                <?php if ($article->discuss) : ?>
                    <?php if (isset($comments) && !empty($comments)) : ?>
                        <div class="uk-grid-small uk-margin-small uk-flex uk-flex-middle" uk-grid>
                            <div class="uk-width-expand">
                                <h3 class="uk-h4 uk-margin-remove"><?= lang('General.comments') ?></h3>
                            </div>
                                                ...
                                                <div class="uk-width-expand">
                                                    <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
                                                        ...
                                                        <div class="uk-width-expand">
                                                            ...
                                                            <p class="uk-text-meta uk-margin-remove"><?= lang('written_on') ?> <time datetime="<?= $comment->createdAt ?>"><?= localeDate($comment->createdAt) ?></time></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="uk-width-auto">
